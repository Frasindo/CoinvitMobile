      ...
      <li class="nav-item mr-2">
        <div class="d-flex flex-row bd-highlight">
          ...
          <div class="p-2 bd-highlight changetheme flex-fill text-center">
            <button href="" class="btn bg-transparent border-less">
                <i class="fas fa-sun"></i>    
              </button>
          </div>
          <div class="p-2 bd-highlight changetheme1 flex-fill text-center">
            <button href="" class=" btn bg-transparent border-less">
...
<!-- swiper -->
    <div class="container-fluid mx-0 pt-2">
      <div class="row">
      ...
      <div class="row mt-2">
        <div class="col-12 px-0">
          <div class="d-flex bd-highlight text-white" id="flex1">
      ...
      <div class="container-fluid mt-4" id="container5">
        <div class="row">
          <div class="col-12">
            <nav>
                        ...
                        <thead>
                         ...
                         <?php
                            ...
                            <tr>
                              ...
                              <td><img id="logotable" src="../logo/btc.png" alt="btc" height="20" width="20"></td>
                              <td>USD <span> anchorusd </span> </span></td>
                              <td>Bitcoin</td>
                              <td>1286578.70</td>
